...
export default function App() {
  const products = [
    { id: '1', title: 'ObsidianInk Dark Art AI Prompt Vault v1', category: 'AI Prompts', price: '$29.00', sales: 64, revenue: 1856.0, paymentUrl: 'https://buy.stripe.com/8x228rgUs115644cG718c1d' },
    { id: '2', title: 'Dark Gothic & Steampunk Tattoo Stencil Collection', category: 'Digital Design', price: '$19.99', sales: 48, revenue: 959.52, paymentUrl: 'https://buy.stripe.com/eVqfZhdIg4dhboofSj18c1e' },
    { id: '3', title: 'Termux Python Automation & Bot Scripts', category: 'Software', price: '$49.00', sales: 18, revenue: 882.0, paymentUrl: 'https://buy.stripe.com/4gM9AT8nWbFJboobC318c1f' },
    { id: '4', title: 'Minimalist Snake & Geometric Line Art Pack', category: 'Digital Design', price: '$14.99', sales: 22, revenue: 329.78, paymentUrl: 'https://buy.stripe.com/cNi7sLcEccJN2RSfSj18c1g' }
  ];
